#!/usr/bin/env python3
"""
Скрипт для выгрузки исторических данных HeadHunter (HHRU) - период с 26.09.2024
"""
...
class HHDataExporter:
    ...
    def run_export(self):
        ...
        # НОВЫЙ ПЕРИОД: с 26.09.2024 по 16.11.2025
        ...
        # Сохраняем на рабочий стол с ФИКСИРОВАННЫМ именем
        ...
        if success:
            ...
            print(f"📅 Период: 26.09.2024 - 16.11.2025")
